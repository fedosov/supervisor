...
class ServerOptionsTests(unittest.TestCase):
    ...
    def test_options(self):
        ...
        self.assertEqual(proc2.restartsignal, -1)
        ...
        self.assertEqual(proc3.restartsignal, -1)
        ...
        self.assertEqual(proc4_a.restartsignal, -1)
        ...
        self.assertEqual(proc4_b.restartsignal, -1)
